...
from service.ditto.core.atomic_components.audio2motion import Audio2Motion
from service.ditto.core.atomic_components.avatar_registrar import (
    AvatarRegistrar,
    smooth_x_s_info_lst,
)
from service.ditto.core.atomic_components.cfg import parse_cfg, print_cfg
from service.ditto.core.atomic_components.condition_handler import (
    ConditionHandler,
    _mirror_index,
)
from service.ditto.core.atomic_components.decode_f3d import DecodeF3D
from service.ditto.core.atomic_components.motion_stitch import MotionStitch
from service.ditto.core.atomic_components.putback import PutBack
from service.ditto.core.atomic_components.warp_f3d import WarpF3D
from service.ditto.core.atomic_components.wav2feat import Wav2Feat
from service.ditto.core.atomic_components.writer import VideoWriterByImageIO
            ...
            while True:
                ...
                if res_kp_seq_valid_start is None:
                    ...
                    valid_res_kp_seq = res_kp_seq[
                        :,
                        res_kp_seq_valid_start : res_kp_seq_valid_start + real_valid_len,
                    ]
