...
from service.ditto.stream_pipeline_offline import StreamSDK
...
def run(
    ...
    setup_kwargs = more_kwargs.get('setup_kwargs', {})  # type: ignore
    run_kwargs = more_kwargs.get('run_kwargs', {})  # type: ignore
